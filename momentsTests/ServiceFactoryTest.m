...
@interface ServiceFactoryTest : XCTestCase <BroadcastServiceDelegate>
...
- (void)testBroadcastService {
    id<BroadcastService> broadcastService = [ServiceFactory broadcastService];
    XCTAssertNotNil(broadcastService);
